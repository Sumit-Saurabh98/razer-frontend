...
function Pc() {
 ...
 const [decodedToken, setDecodedToken] = useState({}); 
  ...
  const getProducts = async() =>{
    const {data} = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/products?sort=${sort}&screen=${screen}&color=${color}`);
 ...
 axios.defaults.headers.common["Authorization"] = `Bearer ${token}`;
  ...
  try {
    const response = await axios.post(`${process.env.REACT_APP_BASE_URL}/cart/add`, {
